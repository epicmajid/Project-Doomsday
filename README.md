...
```mermaid
flowchart TD
    A[Launch Doomsday.exe] --> B[Phase 1: Pre-Execution Alert Box]
    B --> C[Phase 2: MSHTA System Warnings]
    C --> D[Phase 3: Process Flood Simulation]
    D --> E[Phase 4: Interactive Ransomware Narrative]
    E --> F[Phase 5: SAPI SpVoice Audio Alert]
    F --> G[Phase 6: Real-time Notepad Keystroke Engine]
    G --> H[Phase 7: Prank Reveal Dialogue]
```
